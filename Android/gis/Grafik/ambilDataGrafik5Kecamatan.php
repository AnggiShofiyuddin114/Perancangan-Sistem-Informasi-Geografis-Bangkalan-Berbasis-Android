<?php 
	...
	if($_SERVER['REQUEST_METHOD']=='POST'){
		...
		while ($row = mysqli_fetch_array($r)) {
			$detail=$row['BELUM_BEKERJA'].",".$row['APARATUR_PEJABAT_NEGARA'].",".$row['WIRASWASTA'].",".$row['PERTANIAN_DAN_PETERNAKAN'].",".$row['NELAYAN'].",".$row['AGAMA_DAN_KEPERCAYAAN'].",".$row['PELAJAR_DAN_MAHASISWA'].",".$row['TENAGA_KESEHATAN'].",".$row['PENSIUNAN'].",".$row['PEKERJAAN_LAINNYA'];
