...
public class Grafik4Activity extends AppCompatActivity {

    private String JSON_STRING;
    private BarChart mBarChart;
    List<BarEntry> data1,data2;
        ...
        try {
            ...
            refresh.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(getApplicationContext(),Grafik4Activity.class);
    ...
    private void getJSON(){
        class GetJSON extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(Grafik4Activity.this,"Mengambil Data","Mohon Tunggu...",false,false);
            }
            ...
            protected String doInBackground(Void... v) {
                ...
                String s="";
                if (getIntent().getStringExtra("jenis").equals("Kec.")) {
                    s = rh.sendPostRequest(konfigurasi.URL_GET_GRAFIK_KEC4, params);
                }
                else{
                    s = rh.sendPostRequest(konfigurasi.URL_GET_GRAFIK_DS4, params);
                }
                return s;
            }
        }
