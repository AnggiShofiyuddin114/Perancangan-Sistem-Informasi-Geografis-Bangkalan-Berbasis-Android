...
public class Grafik9Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_grafik9);
        ...
        try {
            ...
            refresh.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(getApplicationContext(),Grafik9Activity.class);
...
//            }
    ...
    private void ShowGrafik() {
        ...
        BarData barData = new BarData(dataSet1, dataSet2,dataSet3,dataSet4,dataSet5,dataSet6);
    ...
    private void getJSON(){
        class GetJSON extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(Grafik9Activity.this,"Mengambil Data","Mohon Tunggu...",false,false);
            }
            ...
            protected String doInBackground(Void... v) {
                ...
                String s="";
                if (getIntent().getStringExtra("jenis").equals("Kec.")) {
                    s = rh.sendPostRequest(konfigurasi.URL_GET_GRAFIK_KEC9, params);
                }
                else{
                    s = rh.sendPostRequest(konfigurasi.URL_GET_GRAFIK_DS9, params);
                }
                return s;
            }
        }
