package com.example.dell.sigbangkalan.Menu.Grafik;
...
import com.example.dell.sigbangkalan.Menu.Grafik.GrafikDesa.GrafikDesaActivity;
...
public class MenuGrafikActivity extends AppCompatActivity
    ...
    public boolean onContextItemSelected(MenuItem item) {
        if (item.getTitle() == "Lihat grafik berdasarkan") {
            ...
            intent.putExtra("namaKec",ListData_namaKec.get(item.getGroupId()));
    ...
    private void getJSON(){
        class GetJSON extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(MenuGrafikActivity.this,"Mengambil Data","Mohon Tunggu...",false,false);
            }
