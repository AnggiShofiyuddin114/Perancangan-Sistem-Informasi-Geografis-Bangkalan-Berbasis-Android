...
public class Grafik7Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_grafik7);
        ...
        try {
            ...
            refresh.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(getApplicationContext(),Grafik7Activity.class);
    ...
    private void getJSON(){
        class GetJSON extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(Grafik7Activity.this,"Mengambil Data","Mohon Tunggu...",false,false);
            }
            ...
            protected String doInBackground(Void... v) {
                ...
                String s="";
                if (getIntent().getStringExtra("jenis").equals("Kec.")) {
                    s = rh.sendPostRequest(konfigurasi.URL_GET_GRAFIK_KEC7, params);
                }
                else{
                    s = rh.sendPostRequest(konfigurasi.URL_GET_GRAFIK_DS7, params);
                }
                return s;
            }
        }
