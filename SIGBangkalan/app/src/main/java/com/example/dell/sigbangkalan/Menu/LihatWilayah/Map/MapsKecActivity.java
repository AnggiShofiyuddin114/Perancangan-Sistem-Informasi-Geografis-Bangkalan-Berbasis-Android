...
public class MapsKecActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maps_kec);
    ...
    private void showDistrict() {
        ...
        try {
            ...
            String k = jo.getString(konfigurasi.TAG_K);
            String[] list_k = k.split(",");
            LatLng location = new LatLng(Double.parseDouble(list_k[1]), Double.parseDouble(list_k[0]));
            mMap.animateCamera(
            ...
            refresh.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("id_kec", getIntent().getStringExtra("id_kec"));
    ...
    private void getJSON() {
        class GetJSON extends AsyncTask<Void, Void, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(MapsKecActivity.this, "Mengambil Data", "Mohon Tunggu...", false, false);
            }
            ...
            protected String doInBackground(Void... v) {
                ...
                String s = rh.sendPostRequest(konfigurasi.URL_GET_DATA_KEC,params);
                return s;
            }
        }
