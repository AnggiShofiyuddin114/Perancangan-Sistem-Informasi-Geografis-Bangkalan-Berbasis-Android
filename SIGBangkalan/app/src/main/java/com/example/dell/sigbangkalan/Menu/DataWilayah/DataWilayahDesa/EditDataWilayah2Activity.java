...
public class EditDataWilayah2Activity extends AppCompatActivity {
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_data_wilayah2);
        initViews();
        view();
    }
    private void view() {
    ...
    private void ubahData(){
        ...
        class UbahData extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(EditDataWilayah2Activity.this,"Mengubah Data...","Tunggu...",false,false);
            }
            ...
            protected void onPostExecute(String s) {
                ...
                loading.dismiss();
                if (!s.equals("")) {
                    Toast.makeText(EditDataWilayah2Activity.this, s, Toast.LENGTH_LONG).show();
                    Intent intent = new Intent(EditDataWilayah2Activity.this,LihatDataWilayah2Activity.class);
                    ...
                    Toast.makeText(EditDataWilayah2Activity.this, "Mengubah Data Gagal", Toast.LENGTH_SHORT).show();
                }
            }
