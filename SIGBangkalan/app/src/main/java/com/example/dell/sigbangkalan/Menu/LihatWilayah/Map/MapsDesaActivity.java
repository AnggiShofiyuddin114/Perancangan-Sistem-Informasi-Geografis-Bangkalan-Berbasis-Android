...
public class MapsDesaActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maps_desa);
    ...
    private void showDistrict() {
        ...
        try {
            ...
            if (getIntent().getStringExtra("id_desa").equals("semua_desa")) {
                JSONObject jo = result.getJSONObject(0);
                String k = jo.getString(konfigurasi.TAG_K2);
                String[] list_k = k.split(",");
                location = new LatLng(Double.parseDouble(list_k[1]), Double.parseDouble(list_k[0]));
            }
            else{
                JSONObject jo = result.getJSONObject(0);
                String k = jo.getString(konfigurasi.TAG_K);
            ...
            refresh.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("id_desa", getIntent().getStringExtra("id_desa"));
    ...
    private void getJSON() {
        class GetJSON extends AsyncTask<Void, Void, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(MapsDesaActivity.this, "Mengambil Data", "Mohon Tunggu...", false, false);
            }
            ...
            protected String doInBackground(Void... v) {
                ...
                String s="";
                if (getIntent().getStringExtra("id_desa").equals("semua_desa")){
                    params.put("id",getIntent().getStringExtra("id_kec"));
                    s = rh.sendPostRequest(konfigurasi.URL_GET_DATA_DS_KEC,params);
                }
                else{
                    params.put("id",getIntent().getStringExtra("id_desa"));
                    s = rh.sendPostRequest(konfigurasi.URL_GET_DATA_DS,params);
                }
                return s;
            }
        }
        ...
        if (mMap!=null){
            mMap.setInfoWindowAdapter(new GoogleMap.InfoWindowAdapter() {
                ...
                public View getInfoContents(Marker marker) {
                    View row = getLayoutInflater().inflate(R.layout.activity_info2,null);
                    ...
                    TextView desa,luas_wilayah,ket_tahun,kec;
                    ...
                    desa=row.findViewById(R.id.ds2);
