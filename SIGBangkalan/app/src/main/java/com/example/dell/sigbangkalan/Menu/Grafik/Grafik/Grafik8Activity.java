...
public class Grafik8Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_grafik8);
        ...
        data14 = new ArrayList<BarEntry>();
        data15 = new ArrayList<BarEntry>();
        data16 = new ArrayList<BarEntry>();
        ...
        try {
            ...
            for (int i = 0; i < result.length(); i++) {
                ...
                if (jo.getString("data").equals("true")) {
                    ...
                    data14.add(new BarEntry(thn, Integer.parseInt(d[13])));
                    data15.add(new BarEntry(thn, Integer.parseInt(d[14])));
                    data16.add(new BarEntry(thn, Integer.parseInt(d[15])));
                }
            }
            ...
            refresh.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(getApplicationContext(),Grafik8Activity.class);
...
//            }
    ...
    private void ShowGrafik() {
        ...
        List<BarEntry> data14 = new ArrayList<BarEntry>();
        List<BarEntry> data15 = new ArrayList<BarEntry>();
        List<BarEntry> data16 = new ArrayList<BarEntry>();
        ...
        data14.add(this.data14.get(0));
        data15.add(this.data15.get(0));
        data16.add(this.data16.get(0));
        ...
        BarData barData = new BarData(dataSet1, dataSet2,dataSet3,dataSet4,dataSet5,dataSet6,dataSet7
                ,dataSet8,dataSet9,dataSet10,dataSet11,dataSet12,dataSet13,dataSet14,dataSet15,dataSet16);
    ...
    private void getJSON(){
        class GetJSON extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(Grafik8Activity.this,"Mengambil Data","Mohon Tunggu...",false,false);
            }
            ...
            protected String doInBackground(Void... v) {
                ...
                String s="";
                if (getIntent().getStringExtra("jenis").equals("Kec.")) {
                    s = rh.sendPostRequest(konfigurasi.URL_GET_GRAFIK_KEC8, params);
                }
                else{
                    s = rh.sendPostRequest(konfigurasi.URL_GET_GRAFIK_DS8, params);
                }
                return s;
            }
        }
    ...
    public void pilihData(int pos) {
        if (s_tahun.getCount()!=0) {
            ...
            data14.add(this.data14.get(pos));
            data15.add(this.data15.get(pos));
            data16.add(this.data16.get(pos));
            // Pengaturan atribut bar, seperti warna dan lain-lain
            BarDataSet dataSet1 = new BarDataSet(data1, "1");
            dataSet1.setColor(ColorTemplate.JOYFUL_COLORS[0]);
            dataSet1.setFormSize(5f);
