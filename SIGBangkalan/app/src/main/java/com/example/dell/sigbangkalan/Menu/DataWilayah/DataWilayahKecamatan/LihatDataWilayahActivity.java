...
public class LihatDataWilayahActivity extends AppCompatActivity {
    private String JSON_STRING;
    ArrayList<String> dataKec;
    ArrayList<String> dataIdKec;
    ...
    Spinner tahun;
    TextView kec,luas_wilayah,jum_desa;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lihat_data_wilayah);
        initViews();
        getJSON();
    }

    private void view() {
        String detail1=dataKec.get(0);
        String[] a_detail1=detail1.split(",");
        kec.setText(a_detail1[1]);
        luas_wilayah.setText(fn.formatNumber2(a_detail1[2])+" km2");
        jum_desa.setText(fn.formatNumber(a_detail1[3]));
    ...
    private void initViews() {
        dataKec = new ArrayList<>();
        dataIdKec = new ArrayList<>();
        ...
        jum_desa = findViewById(R.id.jum_desa2);
...
//            tahun.setAdapter(adapter1);
    ...
    private void getJSON() {
        class GetJSON extends AsyncTask<Void, Void, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(LihatDataWilayahActivity.this, "Mengambil Data", "Mohon Tunggu...", false, false);
            }
            ...
            protected String doInBackground(Void... v) {
                ...
                String s = rh.sendPostRequest(konfigurasi.URL_GET_DATA_KEC2,params);
                return s;
            }
        }
    ...
    public void pilihData(int pos) {
        if (!tahun.getSelectedItem().toString().equals("kosong")){
            String detail1=dataKec.get(pos);
            String[] a_detail1=detail1.split(",");
            kec.setText(a_detail1[1]);
            luas_wilayah.setText(fn.formatNumber2(a_detail1[2])+" km2");
            jum_desa.setText(fn.formatNumber(a_detail1[3]));
    ...
    public void editData(View view) {
        if (!tahun.getSelectedItem().equals("kosong")){
            ...
            intent.putExtra("id",getIntent().getStringExtra("id"));
            intent.putExtra("nama",getIntent().getStringExtra("nama"));
            intent.putExtra("id_data",dataIdKec.get(tahun.getSelectedItemPosition()));
    ...
    private void deleteData() {
        class Delete extends AsyncTask<Void, Void, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(LihatDataWilayahActivity.this, "Menghapus Data", "Mohon Tunggu...", false, false);
            }
            ...
            protected void onPostExecute(String s) {
                ...
                loading.dismiss();
                if (!s.equals("")) {
                    Toast.makeText(LihatDataWilayahActivity.this, s, Toast.LENGTH_LONG).show();
                    Intent intent = new Intent(getApplicationContext(),LihatDataWilayahActivity.class);
                    intent.putExtra("jenis","Kec.");
                    intent.putExtra("id",getIntent().getStringExtra("id"));
                    intent.putExtra("nama",getIntent().getStringExtra("nama"));
                    ...
                    Toast.makeText(LihatDataWilayahActivity.this, "Delete Data Gagal", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            protected String doInBackground(Void... v) {
                HashMap<String,String> params = new HashMap<>();
                params.put("jenis","DATA_KEPENDUDUKAN_KECAMATAN");
                params.put("atribut_jenis","ID_DATA_KECAMATAN");
                params.put("id_data",dataIdKec.get(tahun.getSelectedItemPosition()));
                RequestHandler rh = new RequestHandler();
